...
public class FlowLayoutDemo extends JFrame{
 ...
 final JPanel compsToExperiment1 = new JPanel();
        
        compsToExperiment1.setLayout(experimentLayout);
        experimentLayout.setAlignment(FlowLayout.TRAILING);
        ...
        compsToExperiment.add(  new   JTextField("dfgds"));
        ...
        compsToExperiment1.add(  new   JTextField("dfgds"));
        compsToExperiment1.add(new JButton("Button 2"));
        compsToExperiment1.add(new JButton("Button 3"));
        compsToExperiment1.add(new JButton("Long-Named Button 4"));
        compsToExperiment1.add(new JButton("5"));
        //Left to right component orientation is selected by default
        compsToExperiment1.setComponentOrientation(
                ComponentOrientation.LEFT_TO_RIGHT);
        ...
        pane.add(new    JTextField("dfgds"),BorderLayout.SOUTH);
    }
